      ...
      <div className="min-h-screen bg-[#EAEDED]">
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
            <div className="lg:col-span-3 bg-white rounded-lg p-6 animate-pulse">
              <div className="h-8 bg-[#F0F0F0] rounded w-1/3 mb-6" />
              {Array.from({ length: 3 }).map((_, i) => (
                <div key={i} className="flex gap-4 py-4">
                  <div className="w-[180px] h-[180px] bg-[#F0F0F0] rounded shrink-0" />
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg p-6 animate-pulse">
                <div className="h-6 bg-[#F0F0F0] rounded w-full mb-4" />
                <div className="h-10 bg-[#F0F0F0] rounded w-full" />
              </div>
            </div>
          </div>
        </div>
